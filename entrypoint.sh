...
function minecraft_menu {
    while true; do
        ...
        echo -e "\e[32m1) Vanilla  \e[90m(26.1.2 - 1.2.5)\e[0m"
        echo -e "\e[32m2) Paper    \e[90m(26.1.2 - 1.8.8)\e[0m"
        echo -e "\e[32m3) Purpur   \e[90m(26.1.2 - 1.14.1)\e[0m"
        echo -e "\e[32m4) Fabric   \e[90m(26.1.2 - 1.14)\e[0m"
        echo -e "\e[32m5) Forge    \e[90m(26.1.2 - 1.6.2)\e[0m"
        ...
        1)
            ...
            echo -e "\e[32m→ New versioning (2026+): 26.1.2, 26.1.1, 26.1\e[0m"
            echo -e "\e[32m→ Legacy (1.x): 1.21.11 - 1.21, 1.20.6 - 1.20, 1.19.4 - 1.19, 1.18.2 - 1.18, 1.17.1 - 1.17, 1.16.5 - 1.16, 1.15.2 - 1.15, 1.14.4 - 1.14, 1.13.2 - 1.13, 1.12.2 - 1.12, 1.11.2 - 1.11, 1.10.2 - 1.10, 1.9.4 - 1.9, 1.8.9 - 1.8, 1.7.10 - 1.7.2, 1.6.4, 1.6.2, 1.6.1, 1.5.2, 1.5.1, 1.4.7 - 1.4.4, 1.4.2, 1.3.2, 1.3.1, 1.2.5\e[0m"
            read -r input_version
            valid_versions="26.1.2 26.1.1 26.1 1.21.11 1.21.10 1.21.9 1.21.8 1.21.7 1.21.6 1.21.5 1.21.4 1.21.3 1.21.2 1.21.1 1.21 1.20.6 1.20.5 1.20.4 1.20.3 1.20.2 1.20.1 1.20 1.19.4 1.19.3 1.19.2 1.19.1 1.19 1.18.2 1.18.1 1.18 1.17.1 1.17 1.16.5 1.16.4 1.16.3 1.16.2 1.16.1 1.16 1.15.2 1.15.1 1.15 1.14.4 1.14.3 1.14.2 1.14.1 1.14 1.13.2 1.13.1 1.13 1.12.2 1.12.1 1.12 1.11.2 1.11 1.10.2 1.10 1.9.4 1.9.3 1.9.2 1.9.1 1.9 1.8.9 1.8.8 1.8.7 1.8.6 1.8.5 1.8.4 1.8.3 1.8.2 1.8.1 1.8 1.7.10 1.7.9 1.7.8 1.7.7 1.7.6 1.7.5 1.7.4 1.7.3 1.7.2 1.6.4 1.6.2 1.6.1 1.5.2 1.5.1 1.4.7 1.4.6 1.4.5 1.4.4 1.4.2 1.3.2 1.3.1 1.2.5"
        ...
        2)
            ...
            echo -e "\e[32m→ New versioning (2026+): 26.1.2, 26.1.1, 26.1\e[0m"
            echo -e "\e[32m→ Legacy (1.x): 1.21.11, 1.21.10, 1.21.9, 1.21.8, 1.21.7, 1.21.6, 1.21.5, 1.21.4, 1.21.3, 1.21.1, 1.21, 1.20.6, 1.20.5, 1.20.4, 1.20.2, 1.20.1, 1.20, 1.19.4, 1.19.3, 1.19.2, 1.19.1, 1.19, 1.18.2, 1.18.1, 1.18, 1.17.1, 1.17, 1.16.5, 1.16.4, 1.16.3, 1.16.2, 1.16.1, 1.15.2, 1.15.1, 1.15, 1.14.4, 1.14.3, 1.14.2, 1.14.1, 1.14, 1.13.2, 1.13.1, 1.13, 1.12.2, 1.12.1, 1.12, 1.11.2, 1.10.2, 1.9.4, 1.8.8, 1.7.10\e[0m"
            read -r input_version
            valid_versions="26.1.2 26.1.1 26.1 1.21.11 1.21.10 1.21.9 1.21.8 1.21.7 1.21.6 1.21.5 1.21.4 1.21.3 1.21.2 1.21.1 1.21 1.20.6 1.20.5 1.20.4 1.20.3 1.20.2 1.20.1 1.20 1.19.4 1.19.3 1.19.2 1.19.1 1.19 1.18.2 1.18.1 1.18 1.17.1 1.17 1.16.5 1.16.4 1.16.3 1.16.2 1.16.1 1.16 1.15.2 1.15.1 1.15 1.14.4 1.14.3 1.14.2 1.14.1 1.14 1.13.2 1.13.1 1.13 1.12.2 1.12.1 1.12 1.11.2 1.10.2 1.9.4 1.8.8 1.7.10"
        ...
        3)
            ...
            echo -e "\e[32m→ New versioning (2026+): 26.1.2, 26.1.1, 26.1\e[0m"
            echo -e "\e[32m→ Legacy (1.x): 1.21.11, 1.21.10, 1.21.9, 1.21.8, 1.21.7, 1.21.6, 1.21.5, 1.21.4, 1.21.3, 1.21.1, 1.21, 1.20.6, 1.20.4, 1.20.2, 1.20.1, 1.20, 1.19.4, 1.19.3, 1.19.2, 1.19.1, 1.19, 1.18.2, 1.18.1, 1.18, 1.17.1, 1.17, 1.16.5, 1.16.4, 1.16.3, 1.16.2, 1.16.1, 1.15.2, 1.15.1, 1.15, 1.14.4, 1.14.3, 1.14.2, 1.14.1\e[0m"
            read -r input_version
        ...
        4)
            ...
            echo -e "\e[32m→ New versioning (2026+): 26.1.2, 26.1.1, 26.1\e[0m"
            echo -e "\e[32m→ Legacy (1.x): 1.21.11 - 1.21, 1.20.6 - 1.20, 1.19.4 - 1.19, 1.18.2 - 1.18, 1.17.1 - 1.17, 1.16.5 - 1.16, 1.15.2 - 1.15, 1.14.4 - 1.14\e[0m"
            read -r input_version
            valid_versions="26.1.2 26.1.1 26.1 1.21.11 1.21.10 1.21.9 1.21.8 1.21.7 1.21.6 1.21.5 1.21.4 1.21.3 1.21.2 1.21.1 1.21 1.20.6 1.20.5 1.20.4 1.20.3 1.20.2 1.20.1 1.20 1.19.4 1.19.3 1.19.2 1.19.1 1.19 1.18.2 1.18.1 1.18 1.17.1 1.17 1.16.5 1.16.4 1.16.3 1.16.2 1.16.1 1.16 1.15.2 1.15.1 1.15 1.14.4 1.14.3 1.14.2 1.14.1 1.14"
        ...
        5)
            ...
            echo -e "\e[32m→ New versioning (2026+): 26.1.2, 26.1.1, 26.1\e[0m"
            echo -e "\e[32m→ Legacy (1.x): 1.21.8, 1.21.7, 1.21.6, 1.21.5, 1.21.4, 1.21.3, 1.21.1, 1.21, 1.20.6, 1.20.4, 1.20.2, 1.20.1, 1.20, 1.19.4, 1.19.3, 1.19.2, 1.19.1, 1.19, 1.18.2, 1.18.1, 1.18, 1.17.1, 1.16.5, 1.16.4, 1.16.3, 1.16.2, 1.16.1, 1.15.2, 1.15.1, 1.15, 1.14.4, 1.14.3, 1.14.2, 1.13.2, 1.12.2, 1.12.1, 1.12, 1.11.2, 1.11, 1.10.2, 1.10, 1.9.4, 1.9, 1.8.9, 1.8.8, 1.8, 1.7.10, 1.7.2, 1.6.4, 1.6.2\e[0m"
            read -r input_version
            valid_versions="26.1.2 26.1.1 26.1 1.21.8 1.21.7 1.21.6 1.21.5 1.21.4 1.21.3 1.21.1 1.21 1.20.6 1.20.4 1.20.2 1.20.1 1.20 1.19.4 1.19.3 1.19.2 1.19.1 1.19 1.18.2 1.18.1 1.18 1.17.1 1.16.5 1.16.4 1.16.3 1.16.2 1.16.1 1.15.2 1.15.1 1.15 1.14.4 1.14.3 1.14.2 1.13.2 1.12.2 1.12.1 1.12 1.11.2 1.11 1.10.2 1.10 1.9.4 1.9 1.8.9 1.8.8 1.8 1.7.10 1.7.2 1.6.4 1.6.2"
...
function ProxyMenu {
        ...
        1)
            ...
            echo -e "\e[32m→ New versioning (2026+): 26.1.2, 26.1.1, 26.1\e[0m"
            echo -e "\e[32m→ Legacy (1.x): 1.21, 1.20, 1.19, 1.18, 1.17, 1.16, 1.15, 1.14, 1.13, 1.12, 1.11, 1.10, 1.9, 1.8, 1.7, 1.6.4, 1.6.2, 1.6.1, 1.5, 1.4.7, 1.0\e[0m"
            read -r input_version
            valid_versions="26.1.2 26.1.1 26.1 1.21 1.20 1.19 1.18 1.17 1.16 1.15 1.14 1.13 1.12 1.11 1.10 1.9 1.8 1.7 1.6.4 1.6.2 1.6.1 1.5 1.4.7 1.0"
        ...
        2)
            ...
            echo -e "\e[32m→ 3.5.0-SNAPSHOT, 3.4.0-SNAPSHOT, 3.3.0-SNAPSHOT, 3.2.0-SNAPSHOT, 3.1.2-SNAPSHOT, 3.1.1, 3.1.1-SNAPSHOT, 3.1.0, 1.1.9, 1.0.10\e[0m"
            read -r input_version
            valid_versions="3.5.0-SNAPSHOT 3.4.0-SNAPSHOT 3.3.0-SNAPSHOT 3.2.0-SNAPSHOT 3.1.2-SNAPSHOT 3.1.1 3.1.1-SNAPSHOT 3.1.0 1.1.9 1.0.10"
